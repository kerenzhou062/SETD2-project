#!/bin/sh
bamFolder=/data/zhoukr/hhl_setd2_m6a/Hela_m6A-seq
prefix=Hela_m6A-seq
gsize=hg19.chrom.sizes

rm -rf /data/zhoukr/hhl_setd2_m6a/analysis/m6a-seq/Hela/tdf
mkdir -p /data/zhoukr/hhl_setd2_m6a/analysis/m6a-seq/Hela/tdf
cd /data/zhoukr/hhl_setd2_m6a/analysis/m6a-seq/Hela/tdf
