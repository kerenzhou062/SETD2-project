...
shCont_M3_m6a_bed12 = "./m6a-seq/Hela/Hela_m6a_shCont_M3_dependent.bed12"
shSetD2_M3_m6a_bed12 = "./m6a-seq/Hela/Hela_m6a_shSetD2_M3_dependent.bed12"
...
GuitarPlot(gfeatures = feature_M3, GuitarCoordsFromTxDb = gc_hg19_txdb, rescaleComponent=FALSE, saveToPDFprefix = "Hela_m6a_M3")

shCont_m6a_bed12 = "./m6a-seq/Hela/Hela_shCont_m6a.bed12"
shSetD2_m6a_bed12 = "./m6a-seq/Hela/Hela_shSetD2_m6a.bed12"
shCont_m6a = BED12toGRangesList(shCont_m6a_bed12)
shSetD2_m6a = BED12toGRangesList(shSetD2_m6a_bed12)
feature_Hela = list(shCont_m6a, shSetD2_m6a)
names(feature_Hela) = c("shCont", "shSetD2")
GuitarPlot(gfeatures = feature_Hela,GuitarCoordsFromTxDb = gc_hg19_txdb, rescaleComponent=FALSE, saveToPDFprefix = "Hela_m6a")

shCont_M14_m6a_bed12 = "./m6a-seq/Hela/Hela_m6a_shCont_M14_dependent.bed12"
shSetD2_M14_m6a_bed12 = "./m6a-seq/Hela/Hela_m6a_shSetD2_M14_dependent.bed12"
...
GuitarPlot(gfeatures = feature_Combine, GuitarCoordsFromTxDb = gc_hg19_txdb, rescaleComponent=FALSE, saveToPDFprefix = "Hela_m6a_M3_M4")
