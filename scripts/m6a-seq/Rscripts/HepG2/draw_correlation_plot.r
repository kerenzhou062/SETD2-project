...
myData <- read.table("HepG2_m6a_peak_FC_log2.txt",sep="\t",header = TRUE)
log2FC <- myData[14:17]
M <- cor(log2FC)
...
pdf("HepG2_FC_correlation_shM14vs.shSetD2.pdf")
plot(p1)
dev.off()

pdf("HepG2_FC_correlation_shM3vs.shSetD2.pdf")
plot(p2)
dev.off()

pdf("HepG2_FC_correlation_shWTAPvs.shSetD2.pdf")
plot(p3)
dev.off()


pdf("HepG2_FC_correlation_allvs.shSetD2.pdf")
plot(p4)
dev.off()


myData <- read.table("HepG2_m6a_peak_FoldEnrichment_log2.txt",sep="\t",header = TRUE)
...
pdf("HepG2_Erichment_correlation_shM14vs.shSetD2.pdf")
plot(p1)
dev.off()

pdf("HepG2_Erichment_correlation_shM3vs.shSetD2.pdf")
plot(p2)
dev.off()

pdf("HepG2_Erichment_correlation_shWTAPvs.shSetD2.pdf")
plot(p3)
dev.off()


pdf("HepG2_Erichment_correlation_allvs.shSetD2.pdf")
plot(p4)
dev.off()
