...
setwd("/data/zhoukr/hhl_setd2_m6a/analysis/m6a-seq/HepG2/xls/allPeak/")
...
targetFC <- read.table("./target/HepG2_m6A_target_violin_Plot.txt",sep="\t",header = TRUE)
...
pdf("HepG2_m6A_target_violin_Plot.pdf", height=6)
plot(violin)
dev.off()
