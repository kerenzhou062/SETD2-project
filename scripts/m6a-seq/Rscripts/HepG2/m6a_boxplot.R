...
library("ggsignif")
setwd("/data/zhoukr/hhl_setd2_m6a/analysis/m6a-seq/HepG2/boxplot/xls/overlappedPeak")
myData <- read.table(file="HepG2_m6a_peak_FoldEnrichment_log2.txt",header=TRUE)
...
pdf("HepG2_all_sample_m6a_foldEnrichment_log2_boxplot.pdf", height=8)
plot(boxplot)
dev.off()
